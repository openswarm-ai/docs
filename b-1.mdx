...
If you've created [Apps](/customization/views), they appear here as an additional action set. Each App is exposed as a `RenderOutput` call that the agent can invoke to display data. Views have their own per-item permission toggles.
